# Healthcare (Set B) — Base Track: Sovereign RAG (No-Code)

Welcome to the **Base Track** for Healthcare. We will link continuous data folders to a knowledge base.

## Goal
Link Google Drive folders directly to **NotebookLM** for instant Domain RAG.

## Step-by-Step Guide
1. Create a dedicated Google Drive folder for Healthcare policies, manuals, and datasets.
