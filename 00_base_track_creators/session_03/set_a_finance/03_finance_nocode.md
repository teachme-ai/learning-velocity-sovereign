# Finance (Set A) — Base Track: Multi-Agent Swarm (No-Code)

Welcome to the **Base Track** for Finance. We will build a "Visual Swarm" using individual AI Agent nodes in n8n.
...
2. **The Analyst Node**: An AI Agent node prompted to analyze Finance trends.
