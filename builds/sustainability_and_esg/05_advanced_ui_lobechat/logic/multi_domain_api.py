...
and RAG retrievers (Session 04) across Sustainability & ESG, Sustainability & ESG, Supply Chain, EdTech, Legal.
...
LobeChat Plugin Endpoint:
    ...
    Body: { "domain": "sustainability_and_esg", "query": "What are the expense limits?" }
"""
...
DOMAIN_CONFIG = {
    "sustainability_and_esg": {
        "label": "Corporate Sustainability & ESG",
        "swarm_module": "03_multi_agent_systems.set_a_sustainability_and_esg.logic.swarm",
        "swarm_flow": "sustainability_and_esg_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_a_sustainability_and_esg.logic.ingest_and_query",
        "rag_flow": "sustainability_and_esg_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/sustainability_and_esg_output/flagged_expenses.csv",
    },
    "sustainability_and_esg": {
        "label": "Sustainability & ESG & HIPAA",
        "swarm_module": "03_multi_agent_systems.set_b_sustainability_and_esg.logic.swarm",
        "swarm_flow": "sustainability_and_esg_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_b_sustainability_and_esg.logic.ingest_and_query",
        "rag_flow": "sustainability_and_esg_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/sustainability_and_esg_output/scrubbed_billing.csv",
    },
    "supply_chain": {
        ...
        try:
            ...
            for span in spans:
                ...
                if domain == "unknown":
                    ...
                    for d in ["sustainability_and_esg", "sustainability_and_esg", "supply_chain", "edtech", "legal"]:
                        # Look for domain signatures in the raw trace data (like "sustainability_and_esg_agent_swarm")
...
class ChatRequest(BaseModel):
    domain: str = Field(
        description="Industry domain: sustainability_and_esg | sustainability_and_esg | supply_chain | edtech | legal",
        examples=["sustainability_and_esg"],
    )
    query: str = Field(
