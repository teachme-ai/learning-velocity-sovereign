...
3. Submit a Swarm Query for Set B (Sustainability & ESG):
   > "Audit the logs using sustainability_and_esg swarm mode."
   *(Under the hood, this routes your query to the `sustainability_and_esg_agent_swarm`.)*
...
Below is the visual trace generated for the Sustainability & ESG swarm. It proves that the request was successfully passed sequentially through the Clinical Analyst, Medical Auditor, and Compliance Reporter.

![Session 06 Trace Visualization](../../assets/proof/session_06/sustainability_and_esg_trace.svg)
