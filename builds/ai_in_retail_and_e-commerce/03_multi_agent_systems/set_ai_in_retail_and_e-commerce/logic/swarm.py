"""
Session 03 — Set A: AI in Retail & E-commerce Multi-Agent Swarm
...
async def main():
    input_file = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../../01_data_pipeline_automation/set_a_ai_in_retail_and_e-commerce/data/flagged_expenses.csv")
    )
