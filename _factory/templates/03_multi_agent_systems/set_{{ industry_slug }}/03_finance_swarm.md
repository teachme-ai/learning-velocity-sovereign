...
# Launch the Dev UI wired to the {{ industry_name }} Swarm
genkit start -- /tmp/genkit_env/bin/python3 logic/swarm.py
```
Open **http://localhost:4000** → **Flows** → `{{ industry_slug }}_agent_swarm` → **Run** → inspect each agent step in the trace viewer.
...
@ai.flow()
async def {{ industry_slug }}_agent_swarm(input: SwarmInput) -> SwarmOutput:
    ...
...
### Validation Output
![SVG Proof](/Users/khalidirfan/projects/Ai Bootcamps/03_multi_agent_systems/set_a_{{ industry_slug }}/success.svg)

---

# [VALIDATE]
# /tmp/genkit_env/bin/python3 logic/swarm.py
# Confirm: All 3 agents process sequentially, Final Report saved to /tmp/{{ industry_slug }}_output/integrated_report.md

---
**[Back to Curriculum Hub](../../README.md) | [Previous Lab: Session 02](../../02_executive_narrative_engine/set_a_{{ industry_slug }}/02_{{ industry_slug }}_narrative.md) | [Next Lab: Session 04](../../04_sovereign_knowledge_rag/set_a_{{ industry_slug }}/04_{{ industry_slug }}_rag.md)**
