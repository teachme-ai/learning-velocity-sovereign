# Legal (Set E) — Base Track: Data Pipeline (No-Code)

Welcome to the **Base Track** for Legal. Here we orchestrate the data cleaning pipeline using visual node-based workflows.
