# Legal (Set E) — Base Track: Multi-Agent Swarm (No-Code)

Welcome to the **Base Track** for Legal. We will build a "Visual Swarm" using individual AI Agent nodes in n8n.
