...
and RAG retrievers (Session 04) across AI for Educators, AI for Educators, Supply Chain, EdTech, Legal.
...
LobeChat Plugin Endpoint:
    ...
    Body: { "domain": "ai_for_educators", "query": "What are the expense limits?" }
"""
...
DOMAIN_CONFIG = {
    "ai_for_educators": {
        "label": "Corporate AI for Educators",
        "swarm_module": "03_multi_agent_systems.set_a_ai_for_educators.logic.swarm",
        "swarm_flow": "ai_for_educators_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_a_ai_for_educators.logic.ingest_and_query",
        "rag_flow": "ai_for_educators_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_educators_output/flagged_expenses.csv",
    },
    "ai_for_educators": {
        "label": "AI for Educators & HIPAA",
        "swarm_module": "03_multi_agent_systems.set_b_ai_for_educators.logic.swarm",
        "swarm_flow": "ai_for_educators_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_b_ai_for_educators.logic.ingest_and_query",
        "rag_flow": "ai_for_educators_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_educators_output/scrubbed_billing.csv",
    },
    "supply_chain": {
        ...
        try:
            ...
            for span in spans:
                ...
                if domain == "unknown":
                    ...
                    for d in ["ai_for_educators", "ai_for_educators", "supply_chain", "edtech", "legal"]:
                        # Look for domain signatures in the raw trace data (like "ai_for_educators_agent_swarm")
...
class ChatRequest(BaseModel):
    domain: str = Field(
        description="Industry domain: ai_for_educators | ai_for_educators | supply_chain | edtech | legal",
        examples=["ai_for_educators"],
    )
    query: str = Field(
