...
```text
[1/2] Reading policy: corporate_policy_2026.md
[2/2] Chunking text into semantically distinct units...
[3/2] Indexing in ChromaDB (Model: all-MiniLM-L6-v2)...
...
🤖 [HINT]: You may also want to explore the definition of 'ergonomic' and how it applies to company policies.
```
