# AI for Cyber-Security (Set A) — Base Track: Sovereign RAG (No-Code)

Welcome to the **Base Track** for AI for Cyber-Security. We will link continuous data folders to a knowledge base.

## Goal
Link Google Drive folders directly to **NotebookLM** for instant Domain RAG.

## Step-by-Step Guide
1. Create a dedicated Google Drive folder for AI for Cyber-Security policies, manuals, and datasets.
