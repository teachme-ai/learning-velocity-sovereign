...
DOMAINS = {
    "a_ai_for_cyber-security": "AI for Cyber-Security",
    "b_ai_for_cyber-security": "AI for Cyber-Security",
...
def generate():
    ...
    for key, name in DOMAINS.items():
        ...
        with open(s01_dir / f"01_lab_guide.md", "w") as f:
        ...
        with open(s02_dir / f"02_lab_guide.md", "w") as f:
