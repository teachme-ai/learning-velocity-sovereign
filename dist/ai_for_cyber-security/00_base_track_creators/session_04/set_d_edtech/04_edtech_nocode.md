# EdTech (Set D) — Base Track: Sovereign RAG (No-Code)

Welcome to the **Base Track** for EdTech. We will link continuous data folders to a knowledge base.

## Goal
Link Google Drive folders directly to **NotebookLM** for instant Domain RAG.

## Step-by-Step Guide
1. Create a dedicated Google Drive folder for EdTech policies, manuals, and datasets.
