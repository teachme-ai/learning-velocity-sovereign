...
# Launch the Dev UI wired to the AI for Cyber-Security Swarm
genkit start -- /tmp/genkit_env/bin/python3 logic/swarm.py
```
Open **http://localhost:4000** → **Flows** → `ai_for_cyber-security_agent_swarm` → **Run** → inspect each agent step in the trace viewer.
...
@ai.flow()
async def ai_for_cyber-security_agent_swarm(input: SwarmInput) -> SwarmOutput:
    ...
...
### Validation Output
![SVG Proof](/Users/khalidirfan/projects/Ai Bootcamps/03_multi_agent_systems/set_a_ai_for_cyber-security/success.svg)

---

# [VALIDATE]
# /tmp/genkit_env/bin/python3 logic/swarm.py
# Confirm: All 3 agents process sequentially, Final Report saved to /tmp/ai_for_cyber-security_output/integrated_report.md

---
**[Back to Curriculum Hub](../../README.md) | [Previous Lab: Session 02](../../02_executive_narrative_engine/set_a_ai_for_cyber-security/02_ai_for_cyber-security_narrative.md) | [Next Lab: Session 04](../../04_sovereign_knowledge_rag/set_a_ai_for_cyber-security/04_ai_for_cyber-security_rag.md)**