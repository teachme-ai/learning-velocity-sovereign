...
3. Submit a Swarm Query for Set B (AI for Cyber-Security):
   > "Audit the logs using ai_for_cyber-security swarm mode."
   *(Under the hood, this routes your query to the `ai_for_cyber-security_agent_swarm`.)*
...
Below is the visual trace generated for the AI for Cyber-Security swarm. It proves that the request was successfully passed sequentially through the Clinical Analyst, Medical Auditor, and Compliance Reporter.

![Session 06 Trace Visualization](../../assets/proof/session_06/ai_for_cyber-security_trace.svg)
