...
You will now see the `Sovereign Industry Agents` plugin active. You can now prompt LobeChat to "Ask the AI for Cyber-Security agent about travel limits" or "Check the Legal risk of uncapped liabilities," and it will automatically invoke our local Genkit backend!
...
```json
  "description_for_model": "This plugin routes the user's question to one of five professional AI agent swarms... The available domains are: ai_for_cyber-security, ai_for_cyber-security, supply_chain, edtech, legal."
```
