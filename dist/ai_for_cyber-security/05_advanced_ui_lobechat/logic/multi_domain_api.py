...
and RAG retrievers (Session 04) across AI for Cyber-Security, AI for Cyber-Security, Supply Chain, EdTech, Legal.
...
LobeChat Plugin Endpoint:
    ...
    Body: { "domain": "ai_for_cyber-security", "query": "What are the expense limits?" }
"""
...
DOMAIN_CONFIG = {
    "ai_for_cyber-security": {
        "label": "Corporate AI for Cyber-Security",
        "swarm_module": "03_multi_agent_systems.set_a_ai_for_cyber-security.logic.swarm",
        "swarm_flow": "ai_for_cyber-security_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_a_ai_for_cyber-security.logic.ingest_and_query",
        "rag_flow": "ai_for_cyber-security_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_cyber-security_output/flagged_expenses.csv",
    },
    "ai_for_cyber-security": {
        "label": "AI for Cyber-Security & HIPAA",
        "swarm_module": "03_multi_agent_systems.set_b_ai_for_cyber-security.logic.swarm",
        "swarm_flow": "ai_for_cyber-security_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_b_ai_for_cyber-security.logic.ingest_and_query",
        "rag_flow": "ai_for_cyber-security_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_cyber-security_output/scrubbed_billing.csv",
    },
    "supply_chain": {
        ...
        try:
            ...
            for span in spans:
                ...
                if domain == "unknown":
                    ...
                    for d in ["ai_for_cyber-security", "ai_for_cyber-security", "supply_chain", "edtech", "legal"]:
                        # Look for domain signatures in the raw trace data (like "ai_for_cyber-security_agent_swarm")
...
class ChatRequest(BaseModel):
    domain: str = Field(
        description="Industry domain: ai_for_cyber-security | ai_for_cyber-security | supply_chain | edtech | legal",
        examples=["ai_for_cyber-security"],
    )
    query: str = Field(
