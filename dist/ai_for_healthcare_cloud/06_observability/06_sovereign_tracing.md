...
3. Submit a Swarm Query for Set B (AI for Healthcare):
   > "Audit the logs using ai_for_healthcare swarm mode."
   *(Under the hood, this routes your query to the `ai_for_healthcare_agent_swarm`.)*
...
Below is the visual trace generated for the AI for Healthcare swarm. It proves that the request was successfully passed sequentially through the Clinical Analyst, Medical Auditor, and Compliance Reporter.

![Session 06 Trace Visualization](../../assets/proof/session_06/ai_for_healthcare_trace.svg)
