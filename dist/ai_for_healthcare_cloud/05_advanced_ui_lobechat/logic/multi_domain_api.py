...
and RAG retrievers (Session 04) across AI for Healthcare, AI for Healthcare, Supply Chain, EdTech, Legal.
...
LobeChat Plugin Endpoint:
    ...
    Body: { "domain": "ai_for_healthcare", "query": "What are the expense limits?" }
"""
...
DOMAIN_CONFIG = {
    "ai_for_healthcare": {
        "label": "Corporate AI for Healthcare",
        "swarm_module": "03_multi_agent_systems.set_a_ai_for_healthcare.logic.swarm",
        "swarm_flow": "ai_for_healthcare_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_a_ai_for_healthcare.logic.ingest_and_query",
        "rag_flow": "ai_for_healthcare_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_healthcare_output/flagged_expenses.csv",
    },
    "ai_for_healthcare": {
        "label": "AI for Healthcare & HIPAA",
        "swarm_module": "03_multi_agent_systems.set_b_ai_for_healthcare.logic.swarm",
        "swarm_flow": "ai_for_healthcare_agent_swarm",
        "rag_module": "04_sovereign_knowledge_rag.set_b_ai_for_healthcare.logic.ingest_and_query",
        "rag_flow": "ai_for_healthcare_rag_flow",
        "swarm_input_field": "csv_data",
        "session01_output": "/tmp/ai_for_healthcare_output/scrubbed_billing.csv",
    },
    "supply_chain": {
        ...
        try:
            ...
            for span in spans:
                ...
                if domain == "unknown":
                    ...
                    for d in ["ai_for_healthcare", "ai_for_healthcare", "supply_chain", "edtech", "legal"]:
                        # Look for domain signatures in the raw trace data (like "ai_for_healthcare_agent_swarm")
...
class ChatRequest(BaseModel):
    domain: str = Field(
        description="Industry domain: ai_for_healthcare | ai_for_healthcare | supply_chain | edtech | legal",
        examples=["ai_for_healthcare"],
    )
    query: str = Field(
